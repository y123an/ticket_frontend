...
export default function Paymet(props) {
  return (
    <div className="bg-green-300">
      <div className="discription flex bg-gray-400 items-center justify-center">
      ...
      <form action="" className="p-20 flex flex-col text-xl justify-start items-start space-y-6 ">
        ...
        <input type="text" name="fname" className="w-[20%] h-[50px]" />
        <label>Last Name</label>
        <input type="text" name="lname" className="w-[20%] h-[50px]" />
        <p className="text-2xl font-bold text-blue-500">Enter Your Bank Information</p>
        <label>Enter The Bank Name</label>
        <input type="text" name="bname" className="w-[20%] h-[50px]" />
        <label>Enter Your Card Number </label>
        <input type="text" name="cnumber" className="w-[20%] h-[50px]" />
        <button type="submit" className="w-[10%] bg-blue-500 p-4 rounded-lg hover:bg-yellow-300 relative left-44 text-white font-bold">Pay</button>
      </form>
    </div>
  );
}
